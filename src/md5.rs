...
pub fn hash_md5(message: &str) -> String {
    const S: [u32; 64] = [
    ...
    let mut bitvec: BitVec<u8, Msb0> = BitVec::from_slice(message.as_bytes());
...
mod tests {
    ...
    #[test]
    fn check_md5() {
        assert_eq!("7a95bf926a0333f57705aeac07a362a2", hash_md5("PASS"));
        assert_eq!("08054846bbc9933fd0395f8be516a9f9", hash_md5("CODE"));
    }
}
